...
You wake up on a little floating island that has lost all its colour — everything is a soft pencil sketch. In your hands: two magic paintbrushes.

- **Paint in the air.** Pull the trigger and glowing neon ribbons follow your hand. Every stroke drips colour onto the land below, and the island blooms around it: grass, flowers and mushrooms pop up, trees take on your colours, the pond turns blue.
...
- **Pop bubbles, throw paint.** Iridescent bubbles drift over from the pond — poke them for confetti and a splash of colour. Squeeze the grip to conjure a paint ball and hurl it: *splat*.
...
- **Music that follows you.** Chimes are pitched by the height of your hand on a pentatonic scale, so any painting is a melody, and the ambient pad brightens as the world fills with colour.
